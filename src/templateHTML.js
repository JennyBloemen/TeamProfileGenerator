...
// //     return `<li class="list-group-item">Office Number: ${responses.officenumber}</li>`
// //   } else if (responses['role'] == 'Engineer') {
// //     return `<li class="list-group-item">GitHub: <a href="https://github.com/${responses.github()}">${responses.github()}</a></li>`  
// //   } else if (responses['role'] == 'Intern') {
// //     return `<li class="list-group-item">School: ${responses.school}</li>`
